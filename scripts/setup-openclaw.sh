...
echo "If NUC is headless, from your laptop run:"
echo "  ssh -L 8080:localhost:8080 claw@<NUC_IP>"
echo "Then open the URL on your laptop and paste the redirect back."
echo ""
read -p "Press Enter to start onboarding..."
openclaw onboard || echo "⚠ Onboarding exited. Re-run with: openclaw onboard"

echo ""
echo "━━━ Step 2: WhatsApp Pairing ━━━"
echo ""
echo "A QR code will appear. On your phone:"
echo "  WhatsApp → Settings → Linked Devices → Link a Device"
echo "  Scan the QR code"
echo ""
read -p "Press Enter to start WhatsApp pairing..."
...
echo ""
echo "═══════════════════════════════════════════════"
echo "  Done! Send a WhatsApp message to test."
echo ""
